...
export default function NewStudentPage() {
  ...
  const [formData, setFormData] = React.useState({
    ...
    originCourse: '',
    institution: '',
    academicStatus: 'Concluído',
    completionYear: '',
    academicDegree: 'Médio',
    titulation: '',
    externalId: '',
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <TopBar 
          title="Cadastro de Novo Aluno" 
          subtitle="Insira os dados cadastrais para registro nos cursos de extensão" 
        />
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <nav className="flex items-center gap-2 text-sm text-slate-500 mb-2">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-primary font-bold">Cadastro de Aluno</span>
            </nav>

            <div className="flex items-center justify-between mb-8">
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">Cadastro de Novo Aluno</h1>
              <button 
                onClick={() => router.back()}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        value={formData.registrationOrigin}
                        onChange={handleChange}
                        className="w-full px-5 py-3.5 bg-slate-50 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-primary/20 transition-all appearance-none"
                      >
