              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <section className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-bold text-slate-900">Detalhes da Oferta Atual</h2>
                    <span className="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-bold rounded-md uppercase tracking-wider border border-emerald-100">
                      Inscrições Abertas
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Ano/Semestre</p>
                      <p className="font-bold text-slate-900">{course.year} / {course.semester}º</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Ciclo</p>
                      <p className="font-bold text-slate-900">{course.cycle || 'N/A'}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Turma</p>
                      <p className="font-bold text-slate-900">{course.class || 'N/A'}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Trilha</p>
                      <p className="font-bold text-slate-900">{course.track || 'N/A'}</p>
                    </div>
                  </div>

                  <div className="mt-8 p-6 bg-slate-50 rounded-xl border border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                      <div className="size-12 rounded-lg bg-white border border-slate-200 flex items-center justify-center">
                        <User className="w-6 h-6 text-slate-300" />
                      </div>
                      <div>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">{course.responsibleType || 'Responsável'}</p>
                        <p className="text-base font-bold text-slate-900">{course.responsibleName || 'A definir'}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-8">
                      <div className="flex flex-col items-center">
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1 text-center">Início</p>
                      ...
                      <div className="flex flex-col items-center">
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1 text-center">Fim</p>
              ...
              <div className="space-y-8">
                ...
                <section className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="space-y-3">
                    ...
                    <button className="w-full py-3 bg-primary/10 hover:bg-primary/20 rounded-lg text-sm font-bold text-primary transition-all flex items-center justify-center gap-2">
